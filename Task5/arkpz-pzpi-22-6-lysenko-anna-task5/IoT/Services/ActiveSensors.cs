...
public class SensorService
{
    ...
    public async Task<List<int>> GetActiveSensorIdsAsync()
    {
        try
        {
            var response = await _httpClient.GetAsync("http://gasdecsystem1.somee.com/api/sensors/byStatus/activate");
    ...
    {
        var response = await _httpClient.GetAsync("http://gasdecsystem1.somee.com/api/data/latestId");
